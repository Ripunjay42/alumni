...
//   const [adminlogin, setAdminlogin] =useState(false);
  ...
  const handleUserLogin = async (event) => {
    ...
    try {
      const response = await axios.post('https://alumni-server-sigma.vercel.app/login/user', { user_id, password });
  ...
  const handleAdminLogin = async (event) => {
    event.preventDefault();
    try {
      const response = await axios.post('https://alumni-server-sigma.vercel.app/login/admin', adminlog);
